...
for i in [ "Separation","Connection"]:
  print(i + " :")
  obj1 = decode_metric()
  obj1.read_files("/content/Network_Family-metrics_sorted-with-plots.xlsx", i, 0.01, "Sheet1")
  obj1.get_scaling_factors(True)
  obj1.get_metrics()

#Usage
# obj1 = decode_metric()
# obj1.read_files("/content/Network_Family-metrics_sorted-with-plots.xlsx", "Separation", 0.01, "Sheet1")
# obj1.get_scaling_factors(True)
# obj1.get_metrics()
